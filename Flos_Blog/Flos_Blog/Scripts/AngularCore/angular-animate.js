...
// "OR" statement then it would not be enough to catch that.
    ...
    var $AnimateCssProvider = [
        '$animateProvider', /** @this */ function($animateProvider) {
    ...
    var $$AnimateCssDriverProvider = [
        '$$animationProvider', /** @this */ function($$animationProvider) {
...
/* exported $$AnimationProvider */
    ...
    var $$AnimationProvider = [
        '$animateProvider', /** @this */ function($animateProvider) {
            ...
            this.$get = [
                '$$jqLite', '$rootScope', '$injector', '$$AnimateRunner', '$$Map', '$$rAFScheduler',
